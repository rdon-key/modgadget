...
All examples target Cardputer ADV and are built with TinyGo. These examples are
kept intentionally focused on individual ModGadget APIs and hardware behavior.

| example               | purpose                                      | hardware      | main APIs / markup                                                                 |
| --------------------- | -------------------------------------------- | ------------- | ---------------------------------------------------------------------------------- |
| `hello-text`          | Minimal text output                          | Cardputer ADV | `New`, `WithStyles`, `Viewport`, `SetText`, `Render`                               |
| `multilingual-text`   | Multilingual text, styles, markup, and bold  | Cardputer ADV | `StyleSet`, `SetText`, `<style>`, `<b>`, `<br>`                                    |
